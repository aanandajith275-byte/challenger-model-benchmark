...
- Logistic Regression with leakage: **ROC-AUC 0.981**
- Clean Logistic Regression: **ROC-AUC 0.809**
...
3. Logistic Regression achieved ROC-AUC 0.810 in the recorded test run.
4. The tuned XGBoost challenger achieved ROC-AUC 0.791.
5. XGBoost did not provide predictive improvement over the Logistic Regression baseline on the recorded held-out test set.
